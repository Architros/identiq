  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-md overflow-hidden rounded-2xl border border-border/80 bg-surface shadow-[0_16px_48px_rgba(0,0,0,0.12)]"
        ...
        <div className="border-b border-border px-4 py-3">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search for a brand or add a new one..."
                ...
                <li key={brand.id}>
                  ...
                  >
                    ...
                    <span className="flex shrink-0 items-center gap-3 text-xs text-muted">
                      ...
                      <span className="tabular-nums">{brand.updatedAt}</span>
                    </span>
                  </button>
                </li>
              );
