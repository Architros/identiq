...
function ComposerFrost({ children }: { children: React.ReactNode }) {
      ...
      <div
        ...
        className={cn(
          ...
          className ??
            ...
            "relative z-10 shrink-0 isolate bg-transparent",
  ...
  return (
    ...
    <div
      ...
      className={
        ...
        "sticky bottom-0 z-30 -mx-2 shrink-0 isolate bg-transparent"
